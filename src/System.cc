...
System::System(const string &strVocFile, const string &strSettingsFile, const eSensor sensor,
               const bool bUseViewer, const bool bRebuildMap, const string strMap):mSensor(sensor),
...
bool System::SaveMap(const string &Name)
{
    mpMap->Save(Name);
    return true;
}
